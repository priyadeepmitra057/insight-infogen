...
- **Mocked dependencies**: Various mocked elements (requires manual review for specifics)
- **External packages used**: pytest

#### Coverage
- **Tested behaviors**: none
- **Gaps observed**: Full method-level coverage analysis requires dynamic execution. Relying on module-level coverage.
...
- **External packages used**: traceback, pandas
...
- **Mocked dependencies**: none
- **External packages used**: psutil, gc, numpy, pandas
...
#### Dependencies
- **Source files under test**: tests/test_phase2.py, tests/test_phase1.py
- **Mocked dependencies**: none
...
- **Mocked dependencies**: Various mocked elements (requires manual review for specifics)
- **External packages used**: pytest, pandas, numpy, inspect, types
...
- `tests/conftest.py` contains mocks, which might hide real behavior.
- `tests/conftest.py` has no standard `test_` functions identified.
- `tests/run_smoke.py` has no standard `test_` functions identified.
- `tests/run_stress_heavy.py` has no standard `test_` functions identified.
- `tests/run_stress_legacy.py` has no standard `test_` functions identified.
- `tests/run_tests_legacy.py` has no standard `test_` functions identified.
- `tests/test_logging_safety.py` contains mocks, which might hide real behavior.
- `tests/test_ml_integration.py` contains mocks, which might hide real behavior.
- `tests/test_model_security.py` contains mocks, which might hide real behavior.
- `tests/test_passion_engine.py` contains mocks, which might hide real behavior.